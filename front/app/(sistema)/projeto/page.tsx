...
const handleAlterarStatusProjeto = async (projeto: Projeto) => {
    ...
    var dadosRetorno = await
      axios.patch('http://localhost:8080/projetos/' + projeto.id + '/status', novoStatus);
        ...
        <div className="rounded-3xl bg-white/[0.03] border border-white/10 backdrop-blur-xl shadow-2xl shadow-black/40 overflow-x-auto">
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-white/5">
              ...
              {
                projetos.length === 0 && (
                  <tr><td colSpan={7} className="px-6 py-16 text-center text-zinc-500 italic text-sm">Nenhum projeto encontrado</td></tr>
                )
              }
