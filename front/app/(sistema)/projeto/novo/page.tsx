        ...
        <div className="w-full px-6 py-10 md:px-10 md:py-14">
            <div className="max-w-4xl mx-auto">
                <div className="mb-10">
                    ...
                    <div className="mt-5">
                        <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Novo Projeto</h1>
                        <p className="mt-1.5 text-sm text-zinc-400">Preencha os dados para registrar um novo projeto</p>
                    </div>
                </div>
